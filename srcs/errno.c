...
static const t_errno		errno_tab[] = {
...
static const t_errno		errno_ker_tab[] = {
	{"ERESTARTSYS", "To be restarted if SA_RESTART is set"},
	{"ERESTARTNOINTR", ""},
	{"ERESTARTNOHAND", "Restart if no handler..."},
	{"ENOIOCTLCMD", "No ioctl command"},
	{"ERESTART_RESTARTBLOCK", "Restart by calling sys_srestart_syscall"},
	...
	{"EIOCBRETRY", "iocb queued, will trigger a retry"},
};
